  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Centralized alumni profiles & networking
            </p>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-12">
          <div>
            ...
            <p className="mt-4 text-slate-600 max-w-xl">
              A centralized platform for alumni to register, login, update
              profiles, and network across batches — build mentorship, jobs, and
        ...
        <section id="features" className="py-12">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <FeatureCard
              ...
              desc="Quick sign-up and optional verification. Keep your details private or public as you choose."
            />
            <FeatureCard
              title="Update Profile"
              desc="Add work, projects, skills, and interests. Keep your alumni profile current."
            />
            <FeatureCard
              title="Network & Mentor"
              desc="Search alumni by batch, skills, or location. Request mentorship or share opportunities."
            />
          </div>
        </section>
            ...
            {filtered.map((p) => (
              <div key={p.id} className="p-4 border rounded-lg bg-white">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-slate-200 rounded-full font-bold">
                    {p.avatar}
                  </div>
        ...
        {/* CTA */}
        <section className="py-12 flex items-center justify-between bg-indigo-50 rounded-lg p-6">
          <div>
        ...
        <footer className="mt-12 py-8 text-sm text-slate-500">
          <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
            <div>
              © {new Date().getFullYear()} AlumniConnect — Built for alumni
              networks
            </div>
            ...
            <form onSubmit={login} className="mt-4 space-y-3">
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  className="px-4 py-2 rounded"
                  onClick={() => setState((s) => ({ ...s, showLogin: false }))}
                >
                  Cancel
                </button>
                <button
